...
HD_PWD='C:/Users/Wasserman5/Desktop/XUP/ip/KHAZAD_IP/KHAZAD_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KHAZAD.vds -m64 -mode batch -messageDb vivado.pb -notrace -source KHAZAD.tcl
