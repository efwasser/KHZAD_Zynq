...
HD_PWD='C:/Users/Wasserman5/Desktop/XUP/ip/enveloped_KHAZAD_IP/enveloped_KHAZAD_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enveloped_KHAZAD.vds -m64 -mode batch -messageDb vivado.pb -notrace -source enveloped_KHAZAD.tcl
