...
HD_PWD='C:/Users/Wasserman5/Desktop/XUP/ip/wiring_IP/wiring_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wiring.vds -m64 -mode batch -messageDb vivado.pb -notrace -source wiring.tcl
